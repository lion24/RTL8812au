...
#define rtw_g_rates_size ARRAY_SIZE(rtw_rates)
#define rtw_a_rates		(rtw_rates + 4)
#define rtw_a_rates_size (rtw_g_rates_size - 4)

static struct ieee80211_channel rtw_2ghz_channels[] = {
	CHAN2G(1, 2412, 0),	CHAN2G(2, 2417, 0),	CHAN2G(3, 2422, 0),	CHAN2G(4, 2427, 0),
	CHAN2G(5, 2432, 0),	CHAN2G(6, 2437, 0),	CHAN2G(7, 2442, 0),	CHAN2G(8, 2447, 0),
	CHAN2G(9, 2452, 0),	CHAN2G(10, 2457, 0), CHAN2G(11, 2462, 0), CHAN2G(12, 2467, 0),
...
#define RTW_2G_CHANNELS_NUM ARRAY_SIZE(rtw_2ghz_channels)
#define RTW_5G_CHANNELS_NUM ARRAY_SIZE(rtw_5ghz_a_channels)
...
void rtw_5g_rates_init(struct ieee80211_rate *rates)
{
	_rtw_memcpy(rates, rtw_a_rates,
		sizeof(struct ieee80211_rate)*rtw_a_rates_size
	);
}
...
void rtw_cfg80211_indicate_disconnect(_adapter *padapter)
{
	...
	if (!padapter->mlmepriv.not_indic_disco) {
		...
		if(check_fwstate(&padapter->mlmepriv, _FW_LINKED))		
			...
			cfg80211_disconnected(padapter->pnetdev, 0, NULL, 0, 1, GFP_ATOMIC);
#else
                        cfg80211_disconnected(padapter->pnetdev, 0, NULL, 0, GFP_ATOMIC);
#endif
		else
...
static int rtw_cfg80211_add_monitor_if(_adapter *padapter, 
    char *name, 
